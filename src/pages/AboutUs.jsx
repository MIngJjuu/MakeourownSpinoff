...
function AboutUs() {
  ...
  const activities = [
    ...
    { id: 3, image: '/images/발제자료.jpeg', title: '발제 안내', description: '발제자는 영화에 대한 감상을 기반으로 부원들과 함께 나누고 싶은 질문을 발제자료로 제작해 배포합니다.', type: 'activity' },
    { id: 4, image: '/images/MT.jpg', title: 'MT', description: 'MT에서는 영화 게임 등을 통해 부원들과 친목을 도모할 수 있습니다(일정은 추후 공지 예정).', type: 'activity' },
    { id: 5, image: '/images/번개.jpg', title: '번개모임', description: 'GV, 특별 상영회, 단체 관람 등을 부원들과 함께할 수 있습니다.', type: 'activity' },
    { id: 6, image: '/images/종강총회.jpg', title: '종강총회', description: '모든 발제 종료 후 종강총회를 진행합니다.', type: 'activity' },
    { id: 7, image: '/images/5th_magazine.png', title: '웹매거진', description: '웹매거진을 발행하여 한 기수 동안의 활동을 기록하고 공유합니다. 클릭 시 5기 웹매거진으로 이동합니다(6기 매거진은 준비 중입니다)', type: 'magazine', link: 'https://drive.google.com/file/d/18Wun2QRtT2tsKKCFk-wgP2698ck27qCb/view?usp=sharing' },
